  ...
  return (
    <html lang="en" className="antialiased" suppressHydrationWarning>
      <head>
        ...
        {/* Load the icon font without blocking first paint — a slow/blocked
            fonts.googleapis.com must never white-screen the app. Icons simply
            appear when the stylesheet arrives. */}
        <link
